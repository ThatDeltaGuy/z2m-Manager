...
async def async_setup_entry(hass: HomeAssistant, entry: Z2MManagerConfigEntry) -> bool:
    ...
    hub = Z2MHub(
        ...
        networkmap_interval_hours=entry.options.get(
            CONF_NETWORKMAP_INTERVAL_HOURS, DEFAULT_NETWORKMAP_INTERVAL_HOURS
        ),
        ...
        ota_check_interval_days=entry.options.get(
            CONF_OTA_CHECK_INTERVAL_DAYS, DEFAULT_OTA_CHECK_INTERVAL_DAYS
        ),
